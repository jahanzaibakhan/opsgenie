...
def main():
    ...
    parser.add_argument(
        "--request-alert-threshold",
        type=int,
        default=500,
        help="Color application ranking lines red at or above this request count (default: 500)",
    )
    parser.add_argument(
        "--no-color",
        action="store_true",
    ...
    if args.request_alert_threshold < 0:
        parser.error("--request-alert-threshold must be >= 0")
    ...
    print(
        colorize_terminal_report(
            report_txt,
            args.request_alert_threshold,
